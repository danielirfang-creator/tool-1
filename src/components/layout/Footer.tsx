      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-300 bg-slate-800/80 p-3 rounded-xl border border-slate-700/50">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/guides/flooring-waste-percentage-guide" className="text-slate-300 hover:text-emerald-400 transition-colors">
                  Flooring Waste Rules
                </Link>
              </li>
              <li>
                <Link href="/guides/tile-trowel-size-thinset-guide" className="text-slate-300 hover:text-emerald-400 transition-colors">
                  Tile Trowel & Thinset Guide
                </Link>
              </li>
              <li>
                <Link href="/guides/laminate-acclimation-expansion-gap-guide" className="text-slate-300 hover:text-emerald-400 transition-colors">
                  Laminate Acclimation
                </Link>
              </li>
              <li>
                <Link href="/guides/paint-sheen-selection-guide" className="text-slate-300 hover:text-emerald-400 transition-colors">
                  Paint Sheen Reference
                </Link>
              </li>
              <li>
                <Link href="/resources" className="text-slate-300 hover:text-emerald-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/disclaimer" className="text-slate-300 hover:text-emerald-400 transition-colors">
                  Material Disclaimer
                </Link>
              </li>
              <li>
                <Link href="/sitemap" className="text-slate-300 hover:text-emerald-400 transition-colors">
                  HTML Sitemap
                </Link>
              </li>
            </ul>
