...
export const conversionTools: ToolMeta[] = [
  {
    ...
    metaTitle: 'Feet to Metres Converter (ft to m)',
    metaDescription: 'Convert feet (ft) and inches (in) to metres (m) and centimetres (cm) instantly with precision trade decimals, fraction rounding, and reverse calculation.',
  ...
  },
  {
    ...
    metaTitle: 'Inches to MM Converter (in to mm)',
    metaDescription: 'Convert decimal and fractional inches (1/16, 1/8, 1/4, 1/2) to millimetres (mm) and centimetres (cm) with real-time construction precision tables.',
  ...
  },
  {
    ...
    metaTitle: 'Sq Ft to Sq Metres Converter (m²)',
    metaDescription: 'Convert square feet (sq ft) to square metres (m²) instantly with reverse conversion, room dimension calculation, and price per square unit estimator.',
  ...
  },
  {
    ...
    metaTitle: 'Litres to Gallons Converter (L to gal)',
    metaDescription: 'Convert litres (L) to US liquid gallons and UK imperial gallons for paint coverage, liquid sealers, chemical coatings, and fluid volume estimation.',
  ...
  },
  {
    ...
    metaTitle: 'KG to Pounds Converter (kg to lbs)',
    metaDescription: 'Convert kilograms (kg) to pounds (lbs) and ounces (oz) with reverse conversion for construction material weights, structural loads, and freight shipping.',
