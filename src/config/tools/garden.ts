...
export const gardenTools: ToolMeta[] = [
  {
    ...
    metaTitle: 'Gravel Calculator - Tons & Cubic Yards',
    metaDescription: 'Free gravel calculator. Calculate tons, cubic yards, and 50lb bags of crushed stone, pea gravel, and road base with depth estimation and compaction.',
  ...
  },
  {
    ...
    metaTitle: 'Soil Calculator - Topsoil & Dirt Yards',
    metaDescription: 'Calculate topsoil, compost, and raised garden bed soil volume in cubic yards, cubic feet, and bagged quantities with settlement margin calculations.',
  ...
  },
  {
    ...
    metaTitle: 'Mulch Calculator - Bags & Cubic Yards',
    metaDescription: 'Calculate landscaping mulch in cubic yards and 2 cubic foot bags for garden flowerbeds, tree rings, and weed barrier suppression with depth guide.',
  ...
  },
  {
    ...
    metaTitle: 'Turf & Sod Calculator - Sod Pallets',
    metaDescription: 'Calculate sod rolls, whole pallets (450-500 sq ft/pallet), grass seed pounds, and starter fertilizer requirements for lawn turf installations.',
  ...
  },
  {
    ...
    metaTitle: 'Paver Patio Calculator - Base & Sand',
    metaDescription: 'Calculate concrete patio pavers, square feet, base crushed gravel depth, bedding sand, and polymeric joint sand with cutting waste factor." crushed stone base tons, and snap edge restraint.',
