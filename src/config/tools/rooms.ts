...
export const roomTools: ToolMeta[] = [
  {
    ...
    metaTitle: 'Room Area Calculator - Square Footage',
  ...
  },
  {
    ...
    metaTitle: 'Wall Area Calculator - Square Footage',
    metaDescription: 'Calculate net vertical wall surface area for paint, drywall, wallpaper, and insulation, subtracting all doors, windows, and architectural openings.',
  ...
  },
  {
    ...
    metaTitle: 'Square Metres Calculator - m² Area',
  ...
  },
  {
    ...
    metaTitle: 'Wallpaper Calculator - Rolls Needed',
    metaDescription: 'Calculate wallpaper rolls needed factoring wall dimensions, pattern repeat drops, standard roll widths, and window or door cutout deductions." to 25"), and doors/windows.',
  ...
  },
  {
    ...
    metaTitle: 'Baseboard Calculator - Linear Feet',
    metaDescription: 'Calculate linear feet, meterage, and board counts (8ft, 12ft, 16ft) for baseboards, skirting boards, shoe molding, and corner miter waste.',
