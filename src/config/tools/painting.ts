...
export const paintingTools: ToolMeta[] = [
  ...
  },
  {
    ...
    metaDescription: 'Calculate interior wall-only paint coverage in gallons and liters, excluding ceilings and trim, with precise door and window area subtractions.',
  ...
  },
  {
    ...
    metaDescription: 'Estimate flat ceiling paint gallons for smooth drywall, sloped vaults, and textured popcorn ceilings with primer coat calculations.',
  ...
  },
  {
    ...
    metaDescription: 'Calculate primer gallons for new drywall skim coats, dark color transitions, bare wood, stained surfaces, and high-adhesion stain blocking.',
  ...
  },
  {
    ...
    metaDescription: 'Convert wall and ceiling square footage or square meters into exact paint volume in gallons, quarts, and liters with multi-coat multipliers.',
