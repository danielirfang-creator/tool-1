...
export async function GET() {
  ...
  const staticRoutes = [
    ...
    { path: '/calculators/concrete-masonry', priority: '0.8', changefreq: 'weekly', lastmod: '2026-09-11' },
    { path: '/calculators/drywall-framing', priority: '0.8', changefreq: 'weekly', lastmod: '2026-09-11' },
    { path: '/calculators/roofing-siding', priority: '0.8', changefreq: 'weekly', lastmod: '2026-09-11' },
    { path: '/calculators/fencing-decking', priority: '0.8', changefreq: 'weekly', lastmod: '2026-09-11' },
    { path: '/calculators/garden', priority: '0.8', changefreq: 'weekly', lastmod: '2026-09-11' },
